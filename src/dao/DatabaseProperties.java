...
public class DatabaseProperties {
	...
	public DbConfiguration getPropValues() throws IOException, MissingPropertiesFile{
		...
		configuration = new DbConfiguration(prop.getProperty("host"), prop.getProperty("user"), prop.getProperty("password"), prop.getProperty("database"), prop.getProperty("port"));
